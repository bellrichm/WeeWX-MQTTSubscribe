 ...
 PYTHONPATH=bin:./weewx/bin nosetests ./bin/user/tests/func --exe --exclude=setup --cover-package=user.MQTTSubscribe --with-xunit --with-coverage --cover-branches --cover-xml --cover-xml-file=coverage2.xml --xunit-file=nosetests2.xml --verbosity=1
